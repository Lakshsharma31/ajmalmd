...
Example nama file `mymd.json` maka penggunaannya `node . --session 'bersama'`
...
Example server dengan mongodb `mongodb+srv://<username>:<password>@name-of-your-db.thhce.mongodb.net/myFirstDatabase?retryWrites=true&w=majority`

Example server dengan repl `https://json-server.nurutomo.repl.co/`
